...
export function createPrecisionEditBlueprintDefinition(
  ...
  const base: OutcomeBlueprintDefinition = {
    ...
    variables: [
      ...
      { id: "coupledBand", kind: "PARAMETERIZED", description: "Optional coupled preservation band.", critical: false, visibility: ["PRESERVATION_ENGINE", "VERIFIER"], valueType: "NUMBER", required: false, allowedValues: [0, 0.03, 0.05, 0.08, 0.16] },
