...
type Result = {
  ...
  semanticStatus: { machineVerificationStatus: string; machineSameSpecStatus: string; humanAcceptanceStatus: string; outcomeAcceptanceStatus: string; commitEligibilityStatus: string };
