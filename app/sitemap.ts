...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/design-delivery`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/product-delivery`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/ai-understanding`, changeFrequency: "monthly", priority: 0.7 },
