...
export function InboxWorkbench() {
  ...
  return <div className="space-y-6">
    ...
    <section role="tablist" aria-label={t("Operational understanding intake modes", "Modos de captura de entendimiento operativo")} onKeyDown={moveMode} className="grid gap-3 md:grid-cols-2">
      <ModeCard id="inbox-mode-tab-new-event" active={mode === "new-event"} onClick={() => selectMode("new-event")} icon={<FileText size={18} />} title={t("New operational understanding event", "Nuevo evento de entendimiento operativo")} description={t("Analyze a requirement, handoff, process, role need, technical document or AI instruction.", "Analiza un requerimiento, handoff, proceso, necesidad de rol, documento técnico o instrucción para IA.")} />{" "}
