...
export function PublicNavbar() {
  ...
  const anchors = [
    ["#producto", t("Product", "Producto")],
    ["#arquitectura", t("How it works", "Cómo funciona")],
    ["#reporte-ejecutivo", t("Reports", "Reportes")],
    ["#trust", t("Trust", "Confianza")],
  ];
