...
export const modules: VirroModule[] = [
  ...
  { id: "consulting-delivery", label: "Consulting Delivery", href: "/app/consulting-delivery", icon: Boxes, eyebrow: "Analysis pack", description: "Structure discovery as aligned, auditable client delivery.", capabilities: ["Discovery synthesis", "Decision records", "Executive reporting"] },
