...
const spanishModuleCopy: Record<string, Pick<VirroModule, "label" | "eyebrow" | "description" | "capabilities">> = {
  ...
  reports: { label: "Reportes ejecutivos", eyebrow: "Evidencia para decidir", description: "Convierte señales probabilísticas en evidencia para decisiones y gobernanza.", capabilities: ["Reportes ejecutivos", "Exportes de tendencias", "Resúmenes de riesgo"] },
